...
+ [Programming ETL Scripts](aws-glue-programming.md)
   ...
   + [Program AWS Glue ETL Scripts in Scala](aws-glue-programming-scala.md)
      + [Using Scala to Program AWS Glue ETL Scripts](glue-etl-scala-using.md)
      + [List of APIs in the AWS Glue Scala Library](glue-etl-scala-apis.md)
         + [The AWS Glue Scala ChoiceOption APIs](glue-etl-scala-apis-glue-choiceoption.md)
         + [The Abstract DataSink Class](glue-etl-scala-apis-glue-datasink-class.md)
         + [The AWS Glue Scala DataSource Trait](glue-etl-scala-apis-glue-datasource-trait.md)
         + [The AWS Glue Scala DynamicFrame APIs](glue-etl-scala-apis-glue-dynamicframe.md)
         ...
         + [The AWS Glue Scala DynamicRecord Class](glue-etl-scala-apis-glue-dynamicrecord-class.md)
         + [The AWS Glue Scala GlueContext APIs](glue-etl-scala-apis-glue-gluecontext.md)
         + [The AWS Glue Scala ResolveSpec APIs](glue-etl-scala-apis-glue-resolvespec.md)
         + [The AWS Glue Scala ArrayNode APIs](glue-etl-scala-apis-glue-types-arraynode.md)
         + [The AWS Glue Scala BinaryNode APIs](glue-etl-scala-apis-glue-types-binarynode.md)
         + [The AWS Glue Scala BooleanNode APIs](glue-etl-scala-apis-glue-types-booleannode.md)
         + [The AWS Glue Scala ByteNode APIs](glue-etl-scala-apis-glue-types-bytenode.md)
         + [The AWS Glue Scala DateNode APIs](glue-etl-scala-apis-glue-types-datenode.md)
         + [The AWS Glue Scala DecimalNode APIs](glue-etl-scala-apis-glue-types-decimalnode.md)
         + [The AWS Glue Scala DoubleNode APIs](glue-etl-scala-apis-glue-types-doublenode.md)
         + [The AWS Glue Scala DynamicNode APIs](glue-etl-scala-apis-glue-types-dynamicnode.md)
         + [The AWS Glue Scala FloatNode APIs](glue-etl-scala-apis-glue-types-floatnode.md)
         + [The AWS Glue Scala IntegerNode APIs](glue-etl-scala-apis-glue-types-integernode.md)
         + [The AWS Glue Scala LongNode APIs](glue-etl-scala-apis-glue-types-longnode.md)
         + [The AWS Glue Scala MapLikeNode APIs](glue-etl-scala-apis-glue-types-maplikenode.md)
         + [The AWS Glue Scala MapNode APIs](glue-etl-scala-apis-glue-types-mapnode.md)
         + [The AWS Glue Scala NullNode APIs](glue-etl-scala-apis-glue-types-nullnode.md)
         + [The AWS Glue Scala ObjectNode APIs](glue-etl-scala-apis-glue-types-objectnode.md)
         + [The AWS Glue Scala ScalarNode APIs](glue-etl-scala-apis-glue-types-scalarnode.md)
         + [The AWS Glue Scala ShortNode APIs](glue-etl-scala-apis-glue-types-shortnode.md)
         + [The AWS Glue Scala StringNode APIs](glue-etl-scala-apis-glue-types-stringnode.md)
         + [The AWS Glue Scala TimestampNode APIs](glue-etl-scala-apis-glue-types-timestampnode.md)
         + [The AWS Glue Scala GlueArgParser APIs](glue-etl-scala-apis-glue-util-glueargparser.md)
         + [The AWS Glue Scala Job APIs](glue-etl-scala-apis-glue-util-job.md)

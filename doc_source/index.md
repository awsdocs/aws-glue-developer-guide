...
+ [Getting Started Using AWS Glue](getting-started.md)
   + [Setting up IAM Permissions for AWS Glue](getting-started-access.md)
      ...
      + [Step 6: Create an IAM Policy for SageMaker Notebooks](create-sagemaker-notebook-policy.md)
      + [Step 7: Create an IAM Role for SageMaker Notebooks](create-an-iam-role-sagemaker-notebook.md)
...
+ [Creating AWS Glue resources using AWS CloudFormation templates](populate-with-cloudformation-templates.md)
+ [Authoring Jobs in AWS Glue](author-job.md)
   + [Adding Jobs in AWS Glue](add-job.md)
      ...
      + [Adding Streaming ETL Jobs in AWS Glue](add-job-streaming.md)
...
+ [Programming ETL Scripts](aws-glue-programming.md)
   + [General Information about Programming AWS Glue ETL Scripts](aws-glue-programming-general.md)
      ...
      + [Examples: Setting Connection Types and Options](aws-glue-programming-etl-connect-samples.md)
      ...
      + [Cross-Account Cross-Region Access to DynamoDB Tables](aws-glue-programming-etl-dynamo-db-cross-account.md)
   ...
   + [Programming AWS Glue ETL Scripts in Scala](aws-glue-programming-scala.md)
      ...
      + [Scala Script Example - Streaming ETL](glue-etl-scala-example.md)
      + [APIs in the AWS Glue Scala Library](glue-etl-scala-apis.md)
         ...
         + [FillMissingValues Class](glue-etl-scala-apis-glue-ml-fillmissingvalues.md)
         + [FindMatches Class](glue-etl-scala-apis-glue-ml-findmatches.md)
         + [FindIncrementalMatches Class](glue-etl-scala-apis-glue-ml-findincrementalmatches.md)
...
+ [AWS Glue Troubleshooting](troubleshooting-glue.md)
   ...
   + [AWS Glue Machine Learning Exceptions](exceptions-machine-learning.md)
...
+ [AWS Glue Release Notes](release-notes.md)
   + [Running Spark ETL Jobs with Reduced Startup Times](reduced-start-times-spark-etl-jobs.md)

# Program AWS Glue ETL Scripts in Scala<a name="aws-glue-programming-scala"></a>
...
+ [Scala API List](glue-etl-scala-apis.md)
  ...
  + [ChoiceOption](glue-etl-scala-apis-glue-choiceoption.md)
    ...
    + [ChoiceOptionWithResolver](glue-etl-scala-apis-glue-choiceoption.md#glue-etl-scala-apis-glue-dynamicframe-class-defs-)
  ...
  + [GlueContext](glue-etl-scala-apis-glue-gluecontext.md)
    + [getCatalogClient](glue-etl-scala-apis-glue-gluecontext.md#glue-etl-scala-apis-glue-dynamicframe-class-defs-getCatalogClient)
    + [getCatalogSink](glue-etl-scala-apis-glue-gluecontext.md#glue-etl-scala-apis-glue-dynamicframe-class-defs-getCatalogSink)
    + [getCatalogSource](glue-etl-scala-apis-glue-gluecontext.md#glue-etl-scala-apis-glue-dynamicframe-class-defs-getCatalogSource)
    + [getJDBCSink](glue-etl-scala-apis-glue-gluecontext.md#glue-etl-scala-apis-glue-dynamicframe-class-defs-getJDBCSink)
    + [getSink](glue-etl-scala-apis-glue-gluecontext.md#glue-etl-scala-apis-glue-dynamicframe-class-defs-getSink)
    + [getSinkWithFormat](glue-etl-scala-apis-glue-gluecontext.md#glue-etl-scala-apis-glue-dynamicframe-class-defs-getSinkWithFormat)
    + [getSource](glue-etl-scala-apis-glue-gluecontext.md#glue-etl-scala-apis-glue-dynamicframe-class-defs-getSource)
    + [getSourceWithFormat](glue-etl-scala-apis-glue-gluecontext.md#glue-etl-scala-apis-glue-dynamicframe-class-defs-getSourceWithFormat)
    + [getSparkSession](glue-etl-scala-apis-glue-gluecontext.md#glue-etl-scala-apis-glue-dynamicframe-class-defs-getSparkSession)
    + [this](glue-etl-scala-apis-glue-gluecontext.md#glue-etl-scala-apis-glue-dynamicframe-class-defs-this-1)
    + [this](glue-etl-scala-apis-glue-gluecontext.md#glue-etl-scala-apis-glue-dynamicframe-class-defs-this-2)
    + [this](glue-etl-scala-apis-glue-gluecontext.md#glue-etl-scala-apis-glue-dynamicframe-class-defs-this-3)
  + [MappingSpec](glue-etl-scala-apis.md#glue-etl-scala-apis-glue-mappingspec)
    ...
    + [orderingByTarget](glue-etl-scala-apis.md#glue-etl-scala-apis-gluemappingspec-object-val-orderingbytarget)
    + [apply](glue-etl-scala-apis.md#glue-etl-scala-apis-gluemappingspec-object-defs-apply-1)
    + [apply](glue-etl-scala-apis.md#glue-etl-scala-apis-gluemappingspec-object-defs-apply-2)
    + [apply](glue-etl-scala-apis.md#glue-etl-scala-apis-gluemappingspec-object-defs-apply-3)
  + [ResolveSpec](glue-etl-scala-apis-glue-resolvespec.md)
    + [ResolveSpec Object](glue-etl-scala-apis-glue-resolvespec.md#glue-etl-scala-apis-glue-resolvespec-object)
      + [def ](glue-etl-scala-apis-glue-resolvespec.md#glue-etl-scala-apis-resolvespec-object-def-apply_1)
      + [def ](glue-etl-scala-apis-glue-resolvespec.md#glue-etl-scala-apis-resolvespec-object-def-apply_2)
